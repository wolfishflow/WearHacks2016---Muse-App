...
public class MainActivity extends Activity implements OnClickListener {
    ...
    class DataListener extends MuseDataListener {
        ...
        public ArrayList <Float[]> eegArrayList = new ArrayList<Float[]>();
        //public Float [] eegData = new Float[4];
        public long lastTime = 0;
        public int counter;
        public DataArray eegValue = new DataArray();
...
//                Log.i("Artifacts", "blink");
            ...
            if (activity != null) {
                activity.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if ((currentTime - lastTime) / 1000000 > 5) {
                            if (counter < 6000) {
                                Float se1 = Float.parseFloat(String.format(
                                        "%6.2f", data.get(Eeg.FP1.ordinal())));
                                Float se2 = Float.parseFloat(String.format(
                                        "%6.2f", data.get(Eeg.FP2.ordinal())));
                                Float se3 = Float.parseFloat(String.format(
                                        "%6.2f", data.get(Eeg.TP9.ordinal())));
                                Float se4 = Float.parseFloat(String.format(
                                        "%6.2f", data.get(Eeg.TP10.ordinal())));
                                Log.e("DATA",se1.toString());
                                Log.e("DATA",se2.toString());
                                Log.e("DATA",se3.toString());
                                Log.e("DATA",se4.toString());
                                eegValue.setEegData(
                                        se1
                                        , se2
                                        , se3
                                ...
                                eegArrayList.add(counter, eegValue.getArray());

                                counter++;
                            } else {
                                for (Float[] object: eegArrayList
                                     ) {
                                    for (Float object2: object
                                         ) {
                                        Log.e("LogDump",object2.toString());
                                    }
                                }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button a5 = (Button) findViewById(R.id.musicA5);
        a5.setOnClickListener(this);
        Button a6 = (Button) findViewById(R.id.musicA6);
        a6.setOnClickListener(this);
        Button a7 = (Button) findViewById(R.id.musicA7);
        a7.setOnClickListener(this);
        Button a8 = (Button) findViewById(R.id.musicA8);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.refresh) {
        ...
        else if (v.getId() == R.id.musicA5){
            //media = MediaPlayer.create(this, R.raw.a5);
            song = R.raw.a5;
            Log.i("Logcat", "Shit");
        }
        else if (v.getId() == R.id.musicA6){
            song = R.raw.a6;
        }
        else if (v.getId() == R.id.musicA7){
            song = R.raw.a7;
        }
        else if (v.getId() == R.id.musicA8){
            song =  R.raw.a8;
        }
            ...
            if (pairedMuses.size() < 1 ||
                ...
                try {
                    ...
                    media.start();
                    //media.setOnCompletionListener((MediaPlayer.OnCompletionListener) media);
                    media.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                        public void onCompletion(MediaPlayer mp) {
                            Log.i("Song Kill", "Song Kill");
                            System.exit(0);
                        }
                    });
                } catch (Exception e) {
